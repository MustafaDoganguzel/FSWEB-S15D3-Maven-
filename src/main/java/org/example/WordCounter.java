...
public class WordCounter {
  ...
  // texti nokta virgul gibi seylerden arindirmamiz lazim.

        String[] cleanText = text.replaceAll("[^\\p{L}'-]", " ").toLowerCase().split(" ");

        for (String t : cleanText) {
            wordCounter.put(t, wordCounter.getOrDefault(t, 0) + 1);
        }
